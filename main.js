document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
      ...
      ar: {
        ...
        saveSettingsBtn: "💾 حفظ الإعدادات", databaseManagement: "إدارة قاعدة البيانات", databaseManagementHint: "يمكنك أخذ نسخة احتياطية من كل بياناتك في ملف، أو استعادة البيانات من نسخة سابقة. البيانات تحفظ تلقائياً في المتصفح.", exportAllBtn: "💾 تصدير نسخة احتياطية", importAllBtn: "📂 استعادة من ملف", importSuccess: "تم استعادة قاعدة البيانات بنجاح!", importError: "فشل استعادة قاعدة البيانات. الرجاء التأكد من صيغة الملف.", TaxInvoice: "فاتورة ضريبية ",
